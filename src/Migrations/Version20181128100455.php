 ...
 */
final class Version20181128100455 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE proverb (id INT AUTO_INCREMENT NOT NULL, proberb_id INT NOT NULL, country_id INT NOT NULL, body LONGTEXT NOT NULL, popularity INT NOT NULL, UNIQUE INDEX UNIQ_9271AE88D70E78A (proberb_id), UNIQUE INDEX UNIQ_9271AE88F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
